...
public class ScriptAdapter extends BaseAdapter implements ScriptActivityAdapterInterface {
	private Context context;
	private List<Script> spriteScripts;
	...
	public ScriptAdapter(Context context, List<Script> spriteVariables) {
		this.spriteScripts = spriteVariables;
	...
	@Override
	public int getCount() {
		return spriteScripts.size();
	}

	@Override
	public Script getItem(int position) {
		return spriteScripts.get(position);
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.text1.setText(script.getName());
		
		if (holder.localHeadline != null && holder.globalHeadline != null) {
			if (spriteScripts.size() != 0 && position == 0) {
	...
	public List<Script> getCheckedUserVariables() {
		List<Script> vars = new ArrayList<Script>();
